  ...
  template: `
    <div class="l-app">
      ...
      <aside class="l-app__sidebar">
        <a routerLink="/user/catalog" class="c-logo">
        ...
        <nav class="c-nav">
          <ul class="c-nav__list">
            <li class="c-nav__item">
              <a routerLink="/user/catalog" routerLinkActive="c-nav__link--active" class="c-nav__link">
            ...
            <li class="c-nav__item">
              <a routerLink="/user/loans" routerLinkActive="c-nav__link--active" class="c-nav__link">
                <span class="c-nav__icon">
                  <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <li class="c-nav__item">
              <a routerLink="/user/profile" routerLinkActive="c-nav__link--active" class="c-nav__link">
                <span class="c-nav__icon">
                  <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round"
...
export class UserLayoutComponent {
  ...
  readonly userEmail = computed(() => this.authService.decodedToken()?.sub ?? "leitor@bibliotech.com");
